...
def transition_model(current_stage: str, new_stage: str):
    mlflow_transition_model(current_stage=current_stage,new_stage=new_stage)
...
def notify(old_mae, new_mae):
    ...
    channel = '1357' # Change to your batch number
    url = f"{base_url}/{channel}/messages"
    author = 'GasparinB' # Change this to your github nickname
